...
for root, dirs, files in os.walk(source_dir, topdown=True):
    ...
    for name in files:
        ...
        if ext in data["config"]["mediaExts"]:
            ...
            cleanname = cleanname.replace("S1981 E15", "S02E02")
            cleanname = cleanname.replace("S1981 E16", "S02E03")
            cleanname = cleanname.replace("S1981 E17", "S02E04")
            cleanname = cleanname.replace("S1981 E18", "S02E05")
            cleanname = cleanname.replace("S1981 E19", "S02E06")
            cleanname = cleanname.replace("S1981 E20", "S02E07")
            cleanname = cleanname.replace("S1981 E21", "S02E08")
            cleanname = cleanname.replace("S1981 E22", "S02E09")
            cleanname = cleanname.replace("S1981 E23", "S02E10")
            cleanname = cleanname.replace("S1981 E24", "S02E11")
            cleanname = cleanname.replace("S1981 E25", "S02E12")
            cleanname = cleanname.replace("S1981 E26", "S02E13")
            
            cleanname = cleanname.replace("S1982 E27", "S03E01")
            cleanname = cleanname.replace("S1982 E28", "S03E02")
            cleanname = cleanname.replace("S1982 E29", "S03E03")
            cleanname = cleanname.replace("S1982 E30", "S03E04")
            cleanname = cleanname.replace("S1982 E31", "S03E05")
            cleanname = cleanname.replace("S1982 E32", "S03E06")
            cleanname = cleanname.replace("S1982 E33", "S03E07")
            cleanname = cleanname.replace("S1982 E34", "S03E08")
            cleanname = cleanname.replace("S1982 E35", "S03E09")
            cleanname = cleanname.replace("S1982 E36", "S03E10")
            cleanname = cleanname.replace("S1982 E37", "S03E11")
            cleanname = cleanname.replace("S1982 E38", "S03E12")
            cleanname = cleanname.replace("S1982 E39", "S03E13")

            cleanname = cleanname.replace("S1983 E40", "S04E01")
            cleanname = cleanname.replace("S1983 E41", "S04E02")
            cleanname = cleanname.replace("S1983 E42", "S04E03")
            cleanname = cleanname.replace("S1983 E43", "S04E04")
            cleanname = cleanname.replace("S1983 E44", "S04E05")
            cleanname = cleanname.replace("S1983 E45", "S04E06")
            cleanname = cleanname.replace("S1983 E46", "S04E07")
            cleanname = cleanname.replace("S1983 E47", "S04E08")
            cleanname = cleanname.replace("S1983 E48", "S04E09")
            cleanname = cleanname.replace("S1983 E49", "S04E10")
            cleanname = cleanname.replace("S1983 E50", "S04E11")
            cleanname = cleanname.replace("S1983 E51", "S04E12")
            cleanname = cleanname.replace("S1983 E52", "S04E13") 
            
            cleanname = cleanname.replace("S1984 E53", "S04E01")
            cleanname = cleanname.replace("S1984 E54", "S04E02")
            cleanname = cleanname.replace("S1984 E55", "S04E03")
            cleanname = cleanname.replace("S1984 E56", "S04E04")
            cleanname = cleanname.replace("S1984 E57", "S04E05")
            cleanname = cleanname.replace("S1984 E58", "S04E06")
            cleanname = cleanname.replace("S1984 E59", "S04E07")
            cleanname = cleanname.replace("S1984 E60", "S04E08")
            cleanname = cleanname.replace("S1984 E61", "S04E09")
            cleanname = cleanname.replace("S1984 E62", "S04E10")
            cleanname = cleanname.replace("S1984 E63", "S04E11")
            cleanname = cleanname.replace("S1984 E64", "S04E12")
            cleanname = cleanname.replace("S1984 E65", "S04E13")
            cleanname = cleanname.replace("S1984 E66", "S04E14")
            cleanname = cleanname.replace("S1984 E67", "S04E15")
            cleanname = cleanname.replace("S1984 E68", "S04E16")
            cleanname = cleanname.replace("S1984 E69", "S04E17")
            cleanname = cleanname.replace("S1984 E70", "S04E18")
            cleanname = cleanname.replace("S1984 E74", "S04E22")
            cleanname = cleanname.replace("S1984 E75", "S04E23")
            cleanname = cleanname.replace("S1984 E76", "S04E24")
            cleanname = cleanname.replace("S1984 E77", "S04E25")
            cleanname = cleanname.replace("S1984 E78", "S04E26")			
            
            cleanname = cleanname.replace("S1985 E79", "S06E01")
            cleanname = cleanname.replace("S1985 E80", "S06E02")
            cleanname = cleanname.replace("S1985 E81", "S06E03")
            cleanname = cleanname.replace("S1985 E82", "S06E04")
            cleanname = cleanname.replace("S1985 E83", "S06E05")
            cleanname = cleanname.replace("S1985 E84", "S06E06")
            cleanname = cleanname.replace("S1985 E85", "S06E07")
            cleanname = cleanname.replace("S1985 E86", "S06E08")
            cleanname = cleanname.replace("S1985 E87", "S06E09")
            cleanname = cleanname.replace("S1985 E88", "S06E10")

            cleanname = cleanname.replace("S1986 E89", "S07E01")
            cleanname = cleanname.replace("S1986 E90", "S07E02")
            cleanname = cleanname.replace("S1986 E91", "S07E03")
            cleanname = cleanname.replace("S1986 E92", "S07E04")
            cleanname = cleanname.replace("S1986 E93", "S07E05")
            cleanname = cleanname.replace("S1986 E94", "S07E06")
            cleanname = cleanname.replace("S1986 E95", "S07E07")
            cleanname = cleanname.replace("S1986 E96", "S07E08")
            cleanname = cleanname.replace("S1986 E97", "S07E09")
            cleanname = cleanname.replace("S1986 E98", "S07E10")
            cleanname = cleanname.replace("S1986 E99", "S07E11")
            cleanname = cleanname.replace("S1986 E100", "S07E12")
            cleanname = cleanname.replace("S1986 E101", "S07E13")
            cleanname = cleanname.replace("S1986 E102", "S07E14")
            cleanname = cleanname.replace("S1986 E103", "S07E15")
            cleanname = cleanname.replace("S1986 E104", "S07E16")
            cleanname = cleanname.replace("S1986 E105", "S07E17")
            cleanname = cleanname.replace("S1986 E106", "S07E18")
            cleanname = cleanname.replace("S1986 E107", "S07E19")
            cleanname = cleanname.replace("S1986 E108", "S07E20")

            cleanname = cleanname.replace("S1987 E109", "S08E01")
            cleanname = cleanname.replace("S1987 E110", "S08E02")
            cleanname = cleanname.replace("S1987 E111", "S08E03")
            cleanname = cleanname.replace("S1987 E112", "S08E04")
            cleanname = cleanname.replace("S1987 E113", "S08E05")

            cleanname = cleanname.replace("S1989 E114", "S09E01")
            cleanname = cleanname.replace("S1989 E115", "S09E02")
            cleanname = cleanname.replace("S1989 E116", "S09E03")
            cleanname = cleanname.replace("S1989 E117", "S09E04")
            cleanname = cleanname.replace("S1989 E118", "S09E05")
            cleanname = cleanname.replace("S1989 E119", "S09E06")
            cleanname = cleanname.replace("S1989 E120", "S09E07")
            cleanname = cleanname.replace("S1989 E121", "S09E08")
            cleanname = cleanname.replace("S1989 E122", "S09E09")
            cleanname = cleanname.replace("S1989 E123", "S09E10")
            cleanname = cleanname.replace("S1989 E124", "S09E11")
            cleanname = cleanname.replace("S1989 E125", "S09E12")
            cleanname = cleanname.replace("S1989 E126", "S09E13")
            cleanname = cleanname.replace("S1989 E127", "S09E14")
            cleanname = cleanname.replace("S1989 E128", "S09E15")
            cleanname = cleanname.replace("S1989 E130", "S09E17")
            cleanname = cleanname.replace("S1989 E131", "S09E18")
            cleanname = cleanname.replace("S1989 E132", "S09E19")
            cleanname = cleanname.replace("S1989 E133", "S09E20")
            cleanname = cleanname.replace("S1989 E134", "S09E21")
            cleanname = cleanname.replace("S1989 E135", "S09E22")
            cleanname = cleanname.replace("S1989 E136", "S09E23")
            cleanname = cleanname.replace("S1989 E137", "S09E24")
            cleanname = cleanname.replace("S1989 E138", "S09E25")

            cleanname = cleanname.replace("S1990 E139", "S10E01")
            cleanname = cleanname.replace("S1990 E140", "S10E02")
            cleanname = cleanname.replace("S1990 E141", "S10E03")
            cleanname = cleanname.replace("S1990 E142", "S10E04")
            cleanname = cleanname.replace("S1990 E143", "S10E05")
