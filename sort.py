...
for root, dirs, files in os.walk(source_dir, topdown=True):
    ...
    for name in files:
        ...
        if ext in data["config"]["mediaExts"]:
            ...
            cleanname = cleanname.replace("S1984 E53", "S05E01")
            cleanname = cleanname.replace("S1984 E54", "S05E02")
            cleanname = cleanname.replace("S1984 E55", "S05E03")
            cleanname = cleanname.replace("S1984 E56", "S05E04")
            cleanname = cleanname.replace("S1984 E57", "S05E05")
            cleanname = cleanname.replace("S1984 E58", "S05E06")
            cleanname = cleanname.replace("S1984 E59", "S05E07")
            cleanname = cleanname.replace("S1984 E60", "S05E08")
            cleanname = cleanname.replace("S1984 E61", "S05E09")
            cleanname = cleanname.replace("S1984 E62", "S05E10")
            cleanname = cleanname.replace("S1984 E63", "S05E11")
            cleanname = cleanname.replace("S1984 E64", "S05E12")
            cleanname = cleanname.replace("S1984 E65", "S05E13")
            cleanname = cleanname.replace("S1984 E66", "S05E14")
            cleanname = cleanname.replace("S1984 E67", "S05E15")
            cleanname = cleanname.replace("S1984 E68", "S05E16")
            cleanname = cleanname.replace("S1984 E69", "S05E17")
            cleanname = cleanname.replace("S1984 E70", "S05E18")
            cleanname = cleanname.replace("S1984 E74", "S05E22")
            cleanname = cleanname.replace("S1984 E75", "S05E23")
            cleanname = cleanname.replace("S1984 E76", "S05E24")
            cleanname = cleanname.replace("S1984 E77", "S05E25")
            cleanname = cleanname.replace("S1984 E78", "S05E26")			
